...
The network consists of two autoencoders, a decoder, and a discriminator. For example, when training on a dataset that consists of people with glasses and peopl without, we use one encoder to 
