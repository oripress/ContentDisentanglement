...
def train(args):
    ...
    domA_train = CustomDataset(root=os.path.join(args.root, 'trainA.txt'), transform=comp_transform)
    domB_train = CustomDataset(root=os.path.join(args.root, 'trainB.txt'), transform=comp_transform)
